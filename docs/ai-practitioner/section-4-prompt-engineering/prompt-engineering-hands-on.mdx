...
```mermaid
flowchart TD
    subgraph Prompt[The Structured Prompting Framework]
      direction TB
    ...
    Prompt --> E["NEGATIVE PROMPTING (Exclusion Rules):<br>* 'Do not include non-kids/family-friendly activities.'<br>* 'Avoid overly touristy restaurants.'<br>* 'Do not recommend more than 3 activities per day.'"]
```
