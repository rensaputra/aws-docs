...
```mermaid
flowchart TD
    Hierarchy["AWS Certification Hierarchy"]
    Hierarchy --> CP["Cloud Practitioner (CLF-C02)<br/>Focus: Core Cloud Infrastructure"]
    Hierarchy --> AIP["AI Practitioner (AIF-C01)<br/>Focus: AI / ML / GenAI Services"]

    CP --> Assoc["[Associate Level: SAA, DVA, SOA]"]
    AIP --> Spec["[Specialty / Associate: MLA, AIP]"]
```
