...
2. **BATCH MODE (50% Cost Savings)**
   - Asynchronous bulk processing: S3 Input File &rarr; Bedrock &rarr; S3 Output File
...
3. **RIGHT-SIZING FOUNDATION MODELS:**
   - Route short NLP/classification tasks to lightweight models (e.g., Nova Micro/Lite or Titan Text) instead of expensive flagship reasoning models
