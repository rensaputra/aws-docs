...
graph TD
    ...
    Console --> Catalog[Model Catalog<br/>Browse & filter by Provider, Modality, or Use Case]
    Console --> Chat[Chat / Text Playground<br/>Single Prompt vs. Multi-turn Chat, Token Metrics, Latency]
    Console --> Image[Image & Video Playground<br/>Prompt-to-Image Generation, Size, Palette, Count]
```
