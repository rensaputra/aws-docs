...
```mermaid
graph TD
    subgraph Catalog[AMAZON BEDROCK MODEL CATALOG LANDSCAPE]
        Titan[Amazon Titan Family<br/>Text Express / Lite<br/>Multimodal Embeddings<br/>High efficiency, 8K ctx]
        Claude[Anthropic Claude<br/>Claude 3 / 3.5 / 4.5 Sonnet<br/>200K Token Context Window<br/>Complex logic & multi-doc analysis]

        API[Unified Bedrock API Layer<br/>Standardized Input/Output Payload Format]

        Llama[Meta Llama<br/>Llama 2 / Llama 3<br/>Open-weights dialogue<br/>General NLP tasks]
        Stability[Stability AI / Nova Canvas<br/>Stable Diffusion / Nova Canvas<br/>Pure image synthesis & editing<br/>Text-to-Image / Inpainting]
