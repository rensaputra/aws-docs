...
+----------------------+--------------------+--------------------+------------------------+
| Technology Layer     | IaaS (e.g. EC2)    | PaaS (Beanstalk)   | SaaS (Rekognition)     |
+----------------------+--------------------+--------------------+------------------------+
| Applications         | Managed by You     | Managed by You     | Managed by AWS         |
| Data                 | Managed by You     | Managed by You     | Managed by AWS         |
| Runtime              | Managed by You     | Managed by AWS     | Managed by AWS         |
| Middleware           | Managed by You     | Managed by AWS     | Managed by AWS         |
| Operating System     | Managed by You     | Managed by AWS     | Managed by AWS         |
| Virtualization       | Managed by AWS     | Managed by AWS     | Managed by AWS         |
| Servers              | Managed by AWS     | Managed by AWS     | Managed by AWS         |
| Storage              | Managed by AWS     | Managed by AWS     | Managed by AWS         |
| Networking           | Managed by AWS     | Managed by AWS     | Managed by AWS         |
+----------------------+--------------------+--------------------+------------------------+
