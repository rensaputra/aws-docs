...
- [ ] A. Machine Learning models can only be deterministic
- [ ] B. Machine Learning models are deterministic for supervised learning and probabilistic for unsupervised learning
- [ ] C. Machine Learning models can only be probabilistic
- [ ] D. Machine Learning models can be deterministic or probabilistic or a mix of both

<details>
<summary>Correct Answer</summary>

- [x] D. Machine Learning models can be deterministic or probabilistic or a mix of both
  - **Explanation:** Machine Learning models can be deterministic or probabilistic or a mix of both, depending on their nature and how they are designed to operate. Deterministic models always produce the same output given the same input (e.g., Decision Trees). Probabilistic models provide a distribution of possible outcomes rather than a single output, incorporating uncertainty and randomness (e.g., Bayesian Networks). Some models combine both elements, such as neural networks and random forests.  
    ![](./img/are-machine-learning-model-deterministic.png)

<details>
<summary>Incorrect Answers</summary>
- [ ] A. Machine Learning models can only be deterministic
  - **Explanation:** Contradicts the fact that models can be probabilistic or hybrid.
- [ ] B. Machine Learning models are deterministic for supervised learning and probabilistic for unsupervised learning
  - **Explanation:** Acts as a distractor. There is no direct correlation between a model being deterministic/probabilistic and leveraging supervised/unsupervised learning.
- [ ] C. Machine Learning models can only be probabilistic
  - **Explanation:** Contradicts the fact that models can be deterministic or hybrid.
