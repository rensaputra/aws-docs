...
- **Root Account Usage**: The root account is created by default for setup only; it should not be used for everday operations.
- **User Accounts**: Individual user accounts should be created for each perosn in the organization instead of using the root account.
...
- **Principle of Least Previlege**: Users should receive only the permissions necessary for their tasks to enhance security.
