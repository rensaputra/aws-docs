...
- **IAM Access Advisor**: This tool works at the individual **User-level** showing the permissions assigned to users and when those services were last accessed.
  - **Principle of Least Previlege**: The access advisor is particularly helpful in identifyinf unused permissions, enabling admins to adjust access rights and enhance security.
