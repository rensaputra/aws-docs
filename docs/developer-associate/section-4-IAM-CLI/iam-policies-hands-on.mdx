...
- **Restoring Access**: By adding the IAMReadOnlyAccess policy to Rendy, I regain certain permissions, allowing me to view IAM resources without the ability to create new ones.
