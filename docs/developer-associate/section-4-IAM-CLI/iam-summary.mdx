...
- **Groups**: Grouping users into specific groups allows for easier management of permissions. You can define access rights for both users an groups through policies or JSON documents.
