...
- **Mutltiple Group Membership**: Users can belong to more than one group and inhert multiple policies, leading to layered approach in policy assignment.
...
- **IAM Policy Structure**: Key components of a policy include:
  ...
  - **Statement**: Each has:
    ...
    - **Resource**: Details the specific resouces affected.
