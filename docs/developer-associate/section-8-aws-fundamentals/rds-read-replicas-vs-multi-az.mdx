...
🏎️ **Read Replicas (Scability & Performance)**
...
- **The Code Requirement**: Your application code _must_ be updated to use seperate connection strings. Your main app sends `INSERT/UPDATE/DELETE` queries to the primary instance endpoint, and your reporting or read-heavy code points directly to the Read Replica endpoints.
