...
- If the question says **Standard shared file network access**, **file system hierarchy (POSIX)** or **sharing accross multiple AZs**, pick **Amazon Elastic File System (EFS)** instead, we will talk about EFS in the next section, however something to memorize is that Multi-Attach cannot cross AZs; EFS can!
