...
- Choose **EFS** if the question mentions: **POSIX-compliant, standard file hierarchy, mounting accross multiple AZs, or sharing files among hundreds/thousands of instances**
- Choose **EBS Multi-Attach** _only_ if the question specifically highlights: **Clustered Linux apps (like Teradata), raw block-level storage, sub-milisecond latency requirements, and explicitly keep everything within a SINGLE AZ**.
