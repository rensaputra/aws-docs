...
This hands-on session cover the steps for managing EBS sapshots, as well introduces the practical setup for the **Recycle Bin**.  
...
- **The Action**: Snapshots can be copied direcly to any destination AWS region via the console/API.
...
- **Configuration**: You must create a **retention rule** (e.g., settign a retention period like 1 day) and apply it to your resources.
- **Rule Lock Setting**: Leaving a rule "unlocked" means you retain the administrative previlege to delete the rule itself later.
