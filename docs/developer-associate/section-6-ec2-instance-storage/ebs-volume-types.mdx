...
- **gp2 (Older gen)**: Storage size and performance are **linked**. If you want more IOPS, you are forced to pay for a bigger volume size (you get 3 IOPS per GB up to a max of 16,000 IOPS, you will maxed out the IOPS at 5,334 GB and above).
...
- **Maximum Provisioned IOPS Ratio**: 50 IOPS per GB for `io1` and 1000 IOPS per GB for `io2 Block Express`.
