...
- **How it works**: When you click "Connect" in the EC2 console, AWS dynamically creates a **temporary SSH key** behind the scenes, pushes it to your instance, and lets you in automatically.
