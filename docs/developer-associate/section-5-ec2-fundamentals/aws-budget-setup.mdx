...
- **The "Root Account" Prerequisite**
  ...
  - The fix: Log in as the root user, go to **Account**, scroll-down until you find the **IAM User and Role Access to Billing Information** section, click `Edit`, and then check the box that says `Activate IAM Access`. This will allow IAM users with the appropriate permissions to access billing information.
