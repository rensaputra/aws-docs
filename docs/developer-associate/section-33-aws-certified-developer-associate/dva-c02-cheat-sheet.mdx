...
_Every Lambda limit, DynamoDB pattern, CI/CD service and IAM rule the DVA-C02 exam actually tests, organised the way developers build, not the way services are catalogued. Optimised for 1 year of hands-on AWS experience._
...
- **Message size:** 256 KB. For larger payloads, use Extended Client (stores payload in S3, reference in SQS message).
