...
Parameter types are the data type definitions that enforce what kind of input is allowed. The exam loves to test your knowledge of these types, especially when it comes to security and resource referencing.
