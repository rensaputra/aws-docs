...
- **The S3 Log Analysis Rule 🚨:** If a question asks how to run ad-hoc SQL queries on S3 access logs, CloudTrail logs, or VPC Flow Logs without setting up a database or ETL cluster—**choose Amazon Athena.**
